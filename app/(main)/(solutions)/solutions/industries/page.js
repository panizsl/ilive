...
export default function IndustriesPage() {
  ...
  const features = [
    {
      ...
      title: "پزشکی و درمان",
      description:
        "در پلتفرم آیلایو توانستیم با تکیه بر تخصص تیم خود نیاز تمامی افراد متفاوت را برطرف کنیم تا هر شخصی با توجه به نیاز خود توانایی استفاده از آن را داشته باشد.",
    },
    {
      icon: "Play",
  ...
  return (
    <>
      ...
      >
        <Hero
          tagline="صنایع آیلایو"
          title="در هر کسب‌وکاری ما در کنارتان هستیم"
      ...
      <section
        ...
        className="container mx-auto py-10 px-4 desktop:pt-30 desktop:pb-10 desktop:px-20 flex flex-col-2"
      >
        <header className="flex flex-col gap-3 text-center"></header>
        <ShowMoreSection
          visibleCount={6}
      ...
      <section
        ...
        className="container tablet:hidden mx-auto px-4 py-20 flex flex-col gap-6 desktop:px-0 desktop:py-0 desktop:pb-32 desktop:gap-0"
      >
      ...
      {/* Products Section */}
      <section
        className="hidden tablet:block w-full py-10 desktop:py-20"
        aria-labelledby="products-title"
        style={{ backgroundColor: "#042128" }}
      >
